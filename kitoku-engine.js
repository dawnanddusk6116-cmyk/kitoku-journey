...
const STARS={
  1:{k:'一白',j:'一白水星',arch:'静かな賢者',c:'#6dd4e8',elem:'水',elemColor:'#6dd4e8',
     ...
     basho:'温泉・水辺・川沿い・病院・喫茶店・夜の静かな場所',
     shintai:'腎臓・耳・血液・陰部',byoki:'腎臓病・耳の病・冷え・不妊・泌尿器系',
     kaimono:'あまり上等ではないもの。奥にしまい込んであるもの。',
     raihousha:'病気・恋愛の相談・苦境の訴え・部下の話。'},
  2:{k:'二黒',j:'二黒土星',arch:'大地の守人',c:'#c4a043',elem:'土',elemColor:'#c4a043',
     ...
     basho:'農地・田畑・古い家・不動産屋・大衆的な食堂・商店街',
     shintai:'胃・腹部・消化器・子宮',byoki:'胃腸病・腹痛・婦人病・過労・消化器系疾患',
     kaimono:'大衆的な安物。古いが量が多く質は大衆化したもの。',
     raihousha:'土地家屋・古い知人・家庭内・営業の話。'},
  3:{k:'三碧',j:'三碧木星',arch:'夜明けの先駆者',c:'#78d060',elem:'木',elemColor:'#78d060',
     ...
     basho:'電気店・楽器店・スポーツ施設・東の方向・新しい施設',
     shintai:'肝臓・喉・声帯・足・神経',byoki:'肝臓病・声の病・神経系・足の怪我・発熱',
     kaimono:'見かけは良いが中身は伴わないもの。派手な宣伝品。',
     raihousha:'新しくスタートした話。抗議・自分の意見ではなく受け売り。'},
  4:{k:'四緑',j:'四緑木星',arch:'縁結びの風',c:'#56cc94',elem:'木',elemColor:'#56cc94',
     ...
     basho:'空港・旅行代理店・神社・遠方・道路沿い・緑豊かな場所',
     shintai:'腸・気管・神経・頭髪・筋肉',byoki:'腸の病・呼吸器系・神経痛・脱毛・気管支炎',
     kaimono:'比較的整った物。使いやすくて便利なもの。',
     raihousha:'遠方・旅行・縁談・話をまとめようとする努力。'},
  5:{k:'五黄',j:'五黄土星',arch:'孤高の帝王',c:'#d4a830',elem:'土',elemColor:'#d4a830',
     ...
     basho:'中心地・政府機関・古い建物・廃墟・神社仏閣',
     shintai:'脾臓・大腸・消化器全般・五臓六腑',byoki:'ガン・重篤な病全般・高熱・腫れ物・慢性疾患',
     kaimono:'古いもの・腐ったもの。見えないところにキズがあるもの。',
     raihousha:'言葉に嘘がある。紛争問題・古い病気の話・甘い話。'},
  6:{k:'六白',j:'六白金星',arch:'天命のリーダー',c:'#b8cce0',elem:'金',elemColor:'#b8d0e8',
     ...
     basho:'高級ホテル・神社仏閣・官公庁・銀行・北西の高台・格式ある場所',
     shintai:'頭部・肺・大腸・骨・脳',byoki:'頭部の病・肺の病・骨折・高血圧・脳の疾患',
     kaimono:'高級品で一流品。値が張るが珍しいもの（予算オーバーしやすい）。',
     raihousha:'信仰・新しい希望・投資・争い事・ケンカの話。'},
  7:{k:'七赤',j:'七赤金星',arch:'喜びの使者',c:'#e870a0',elem:'金',elemColor:'#e87090',
     color:'ピンク・オレンジ・金',food:'辛味のもの・甘いもの・鶏肉・お菓子',
     conbini:['サラダチキン・白いチキン系','烏龍茶・ジャスミン茶','白あんまん・白玉系スイーツ'],
     basho:'飲食店・カフェ・居酒屋・カラオケ・結婚式場・西の繁華街',
     shintai:'口・歯・肺・胸部・咽頭',byoki:'口腔疾患・歯痛・肺の病・胸部疾患・喘息',
     kaimono:'販売員に愛嬌がある。セールストークが上手で買ってしまうもの。',
     raihousha:'祝い事・ロマンス・マネーの貸し借り・恋愛の話。'},
  8:{k:'八白',j:'八白土星',arch:'不屈の継承者',c:'#a09878',elem:'土',elemColor:'#b0a888',
     ...
     basho:'山・神社仏閣・ホテル・高台・北東エリア・倉庫・温泉旅館',
     shintai:'腰・背中・関節・手足・脊髄・肩',byoki:'腰痛・関節炎・リウマチ・骨折・蓄膿症',
     kaimono:'詰め合わせ。キズや凹みがありそうなもの（修理品）。',
     raihousha:'家庭内・新築・土地購入・親類問題の話。'},
  9:{k:'九紫',j:'九紫火星',arch:'真実の炎',c:'#e86070',elem:'火',elemColor:'#e86070',
     ...
     basho:'学校・裁判所・美容院・図書館・デパート・南の繁華街・美術館',
     shintai:'心臓・目・頭脳・精神・乳房',byoki:'心臓病・眼病・頭痛・精神疾患・高熱・不眠',
     kaimono:'見た目が美しいもの。センスが良いもの。高層階での出会い。',
     raihousha:'物見遊山・観劇・政治・事件・投資の話。'},
};
...
// ── 道軌の法則（蔵より）──
const DOUKI={
  ten:{nums:[3,6,9],label:'天数系列',omote:'前進・頑張り・明るさ・勇気・元気',ura:'助言・指導・明るさ・勇気・元気',senro:'丑・辰・未・戌の日'},
  chi:{nums:[2,5,8],label:'地数系列',omote:'努力・不屈・陰ひなたなし・地道',ura:'温かみ・優しさ・寛容・親分肌',senro:'寅・巳・申・亥の日'},
  jin:{nums:[1,4,7],label:'人数系列',omote:'融和・円満・調和',ura:'同調・理解・共感・受け入れる',senro:'子・卯・午・酉の日'},
};
function getDouki(h){
  if([3,6,9].includes(h)) return DOUKI.ten;
  if([2,5,8].includes(h)) return DOUKI.chi;
  return DOUKI.jin;
}
// ── 傾斜テーマ（蔵より）──
const KEISHA_THEME={
  1:'柔軟に人に合わせる・裏方に徹する・深く考える力',
  2:'地道にコツコツ育てる・母のような包容力で支える力',
  3:'新しいことを元気よく始める・声を出して引っ張る力',
  4:'人と人を結びつける・縁を整える力',
  5:'誰もやりたがらない困難を強い決意で引き受ける力',
  6:'高い理想を持ちリーダーシップを発揮する力',
  7:'周りに喜びと楽しさを与える・言葉や食事で笑顔にする力',
  8:'組織や家族の継承者となる・大きな変化や改革を起こす力',
  9:'専門性を極め真実を照らす・美しい知恵で周りを導く力',
};
// ── 五大凶方の心構え（蔵より）──
const KYOUHOU_KOKOROGAMAE={
  '五黄殺':['明るい笑顔で生活する','始めに相手の要望を聞き、自分の主張を固持しない','怒らない、イライラしない'],
  '暗剣殺':['相手を傷つけやすいから注意','恩人にはお礼の言葉を','一時停止と赤信号に気をつけて'],
  '破壊殺':['自分の目標をしっかりと','予定通りに進まずとも、不満を言わずに対応する','あきらめない','事故やケガに注意'],
  '本命殺':['無理はしない','自分の役割を自覚する','わがままを通さない、人に強制しない'],
  '本命的殺':['予想と違っていても驚かないこと','目的をいつまでも固定しないように'],
};
...
const NICHIBAN_ANCHORS={2025:{yoto:{ref:new Date(2025,2,6),stem:1,branch:0,star:9,endDate:new Date(2025,5,21)},into:{ref:new Date(2025,5,22),stem:2,branch:1,star:8}},2026:{yoto:{ref:new Date(2026,2,4),stem:3,branch:1,star:2,endDate:new Date(2026,5,20)},into:{ref:new Date(2026,5,21),stem:2,branch:2,star:7}},2027:{yoto:{ref:new Date(2027,2,6),stem:5,branch:3,star:9,endDate:new Date(2027,5,21)},into:{ref:new Date(2027,5,22),stem:6,branch:4,star:8}},2028:{yoto:{ref:new Date(2028,2,5),stem:7,branch:5,star:7,endDate:new Date(2028,5,20)},into:{ref:new Date(2028,5,21),stem:8,branch:6,star:6}},2029:{yoto:{ref:new Date(2029,2,5),stem:0,branch:6,star:1,endDate:new Date(2029,5,20)},into:{ref:new Date(2029,5,21),stem:8,branch:6,star:9}},2030:{yoto:{ref:new Date(2030,2,5),stem:5,branch:11,star:6,endDate:new Date(2030,5,20)},into:{ref:new Date(2030,5,21),stem:3,branch:11,star:4}},2031:{yoto:{ref:new Date(2031,2,6),stem:1,branch:5,star:3,endDate:new Date(2031,5,20)},into:{ref:new Date(2031,5,21),stem:8,branch:4,star:8}},2032:{yoto:{ref:new Date(2032,2,5),stem:6,branch:10,star:8,endDate:new Date(2032,5,21)},into:{ref:new Date(2032,5,22),stem:5,branch:11,star:1}},2033:{yoto:{ref:new Date(2033,2,5),stem:1,branch:3,star:4,endDate:new Date(2033,5,20)},into:{ref:new Date(2033,5,21),stem:9,branch:3,star:6}},2034:{yoto:{ref:new Date(2034,2,5),stem:6,branch:8,star:9,endDate:new Date(2034,5,21)},into:{ref:new Date(2034,5,22),stem:5,branch:9,star:9}},2035:{yoto:{ref:new Date(2035,2,6),stem:2,branch:2,star:9,endDate:new Date(2035,5,20)},into:{ref:new Date(2035,5,21),stem:9,branch:1,star:5}},2036:{yoto:{ref:new Date(2036,2,5),stem:7,branch:7,star:5,endDate:new Date(2036,5,20)},into:{ref:new Date(2036,5,21),stem:5,branch:7,star:8}},2037:{yoto:{ref:new Date(2037,2,5),stem:2,branch:0,star:1,endDate:new Date(2037,5,20)},into:{ref:new Date(2037,5,21),stem:0,branch:0,star:9}},2038:{yoto:{ref:new Date(2038,2,5),stem:7,branch:5,star:6,endDate:new Date(2038,5,20)},into:{ref:new Date(2038,5,21),stem:5,branch:5,star:4}},2039:{yoto:{ref:new Date(2039,2,6),stem:3,branch:11,star:3,endDate:new Date(2039,5,20)},into:{ref:new Date(2039,5,21),stem:0,branch:10,star:8}},2040:{yoto:{ref:new Date(2040,2,5),stem:8,branch:4,star:8,endDate:new Date(2040,5,21)},into:{ref:new Date(2040,5,22),stem:7,branch:5,star:1}}};
...
// [UNUSED] この関数は現在、どのページからも呼び出されていません（2026-08-27確認）。
// direction_v2.html等は同名関数を自前で持っており、この関数には依存していません。
// 削除・移動を検討する場合は、再度全ファイルを横断検索してから行ってください。
...
// [UNUSED] openDirPopup の関数定義は現在このファイル内に存在せず、未使用ブロック内の参照だけが残っています（2026-08-27確認）。
// direction_v2.html等は同名関数を自前で持っており、この参照には依存していません。
// 削除・移動を検討する場合は、再度全ファイルを横断検索してから行ってください。
// ── 方位ポップアップ ──
